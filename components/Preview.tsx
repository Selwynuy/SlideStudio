...
export default function Preview({
  ...
  if (slideAspect > frameAspect) {
    // Slide wider than frame — fit to width
    slideRenderWidth = BASE_FRAME_WIDTH;
    slideRenderHeight = BASE_FRAME_WIDTH / slideAspect;
  } else {
    // Slide taller than frame — fit to height
    slideRenderHeight = BASE_FRAME_HEIGHT;
    slideRenderWidth = BASE_FRAME_HEIGHT * slideAspect;
  }

  // canvasScale: maps RenderedSlide (dims.width × dims.height) → phone frame slot
  // i.e. dims.width * canvasScale === slideRenderWidth
      ...
      <div className="preview-scroll" id="previewScroll">
        ...
        >
          ...
          >
            ...
            {/* TikTok / phone chrome overlays — purely decorative, sized for phone frame */}
            {showTikTokUI && (
              <>
                ...
                <div className="tiktok-ui">
                  ...
                  <div className="tiktok-action">
                    <div className="tiktok-disc">
                      <div className="tiktok-disc-inner" />
                    </div>
                  </div>
                </div>
